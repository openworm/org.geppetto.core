...
var sweeps=[];
for(var i=0;i<GEPPETTO.ModelFactory.allPaths.length;i++){if(GEPPETTO.ModelFactory.allPaths[i].path.indexOf("Sweep")!=-1 && GEPPETTO.ModelFactory.allPaths[i].metaType=="CompositeType"){sweeps.push(Instances.getInstance(GEPPETTO.ModelFactory.allPaths[i].path));}};
...
GEPPETTO.ControlPanel.addData(sweeps);
