...
GEPPETTO.ControlPanel.setControlsConfig({ "VisualCapability": {}, "Common": { "plot": { "id": "plot", "actions": ["$instance$.getVariables()[0].getValue().resolve()"], "icon": "fa-eye", "label": "Plot", "tooltip": "Plot Sweep" } } }); 
